...
import org.example.Model.Entity.Enemies.Attack;
import org.example.Model.Entity.Enemies.Bowser;
import org.example.Model.Entity.Enemies.Koopa;
import org.example.Model.Entity.Items.Coin;
import org.example.Model.Entity.Items.MagicFlower;
import org.example.Model.Entity.Items.MagicMushroom;
import org.example.Model.Entity.Items.MagicStar;
...
import org.example.View.CheckPointPanel;
...
public class Player extends Entity {
    ...
    public Player(int x, int y, int width, int height , Id id, Handler handler , PlayerState playerState) {
    ...
    public void hitGate(Gate gate){
        if(!gate.isActive()) {
            ...
            MainFrame.getInstance().setContentPane(new CheckPointPanel(getHandler() , gate));
        }
    }
    public void fall(){
        getHandler().getGame().setScore(getHandler().getGame().getScore() - 30);
